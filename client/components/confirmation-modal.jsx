          ...
          <div className="row">
            <div className="col">
              <p className="checkout-font">
                ...
                <br/><br/>
                Your information will <strong>NOT</strong> be saved and there will be <strong>no</strong> charge whatsoever to any 16-digit number that you inputted into the Card Information field.
              </p>
            </div>
          </div>
          <div className="row">
